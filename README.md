# Ignition IIOT Project Template

___

## Prerequisite

Understand the process of creating docker containers using the [iiot-docker-image](https://github.com/design-group/ignition-docker).
